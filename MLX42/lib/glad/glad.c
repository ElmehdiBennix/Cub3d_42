...
PFNGLDISABLEVERTEXARray_aTTRIBPROC glad_glDisableVertexArray_attrib = NULL;
...
PFNGLENABLEVERTEXARray_aTTRIBPROC glad_glEnableVertexArray_attrib = NULL;
...
PFNGLVERTEXARray_aTTRIBBINDINGPROC glad_glVertexArray_attribBinding = NULL;
PFNGLVERTEXARray_aTTRIBFORMATPROC glad_glVertexArray_attribFormat = NULL;
PFNGLVERTEXARray_aTTRIBIFORMATPROC glad_glVertexArray_attribIFormat = NULL;
PFNGLVERTEXARray_aTTRIBLFORMATPROC glad_glVertexArray_attribLFormat = NULL;
...
static void load_GL_VERSION_4_5(GLADloadproc load) {
	...
	glad_glDisableVertexArray_attrib = (PFNGLDISABLEVERTEXARray_aTTRIBPROC)load("glDisableVertexArray_attrib");
	glad_glEnableVertexArray_attrib = (PFNGLENABLEVERTEXARray_aTTRIBPROC)load("glEnableVertexArray_attrib");
	...
	glad_glVertexArray_attribBinding = (PFNGLVERTEXARray_aTTRIBBINDINGPROC)load("glVertexArray_attribBinding");
	glad_glVertexArray_attribFormat = (PFNGLVERTEXARray_aTTRIBFORMATPROC)load("glVertexArray_attribFormat");
	glad_glVertexArray_attribIFormat = (PFNGLVERTEXARray_aTTRIBIFORMATPROC)load("glVertexArray_attribIFormat");
	glad_glVertexArray_attribLFormat = (PFNGLVERTEXARray_aTTRIBLFORMATPROC)load("glVertexArray_attribLFormat");
